...
filters: {"gender":"any","race":"any","minAge":25,"maxAge":50,"education":"college","experience":"experienced","union":false,"maritalStatus":"any"}
---
**Cybersecurity Analyst**

Protect critical financial systems from cyber threats! Join our security team and help defend against the latest attacks.

**What You'll Do:**
- Monitor security dashboards for threats, alerts, and anomalies
- Investigate security incidents (malware, phishing, breaches)
- Analyze logs, network traffic, and system events
- Respond to incidents and contain threats
- Work with SIEM tools, firewalls, and intrusion detection systems
...
*High-stakes environment where one mistake can cost millions. Constant learning required - new threats emerge daily. Security never sleeps - must be available for on-call rotations.*
